...
const badgeVariants = cva(
  "web:inline-flex web:transition-colors web:focus:outline-hidden web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2 items-center rounded-full border border-border px-2.5 py-0.5",
  {
    variants: {
      variant: {
        default:
